...
import mailinabox_api.models
from mailinabox_api import rest
from mailinabox_api.exceptions import ApiValueError, ApiException
...
class ApiClient(object):
    ...
    def __init__(
        ...
        self.user_agent = "OpenAPI-Generator/0.46.4/python"
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(mailinabox_api.models, klass)
