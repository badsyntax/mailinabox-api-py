...
class DNSRecordType(object):
    ...
    allowable_values = [A, AAAA, CAA, CNAME, TXT, MX, SRV, SSHFP, NS]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """DNSRecordType - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DNSRecordType):
            return False
