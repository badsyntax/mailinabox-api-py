...
class MailUserPrivilege(object):
    ...
    allowable_values = [ADMIN, EMPTY]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """MailUserPrivilege - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MailUserPrivilege):
            return False
