...
class MailUserRemoveRequest(object):
    ...
    @property
    def email(self):
        """Gets the email of this MailUserRemoveRequest.  # noqa: E501

        Email format.  # noqa: E501

        :return: The email of this MailUserRemoveRequest.  # noqa: E501
        :rtype: str
        """
        return self._email
    ...
    def email(self, email):
        """Sets the email of this MailUserRemoveRequest.

        Email format.  # noqa: E501

        :param email: The email of this MailUserRemoveRequest.  # noqa: E501
        :type: str
        """
        if (
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MailUserRemoveRequest):
            return False
