...
import mailinaboxapi.models
from mailinaboxapi import rest
from mailinaboxapi.exceptions import ApiValueError, ApiException
...
class ApiClient(object):
    ...
    def __init__(
        ...
        self.user_agent = "OpenAPI-Generator/0.0.0-SNAPSHOT.5/python"
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(mailinaboxapi.models, klass)
